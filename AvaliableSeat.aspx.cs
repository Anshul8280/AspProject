...
{
    public partial class AvaliableSeat : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from BusDetails where Source='" + txtFrom.Text + "' and Destination='"+ txtTo.Text +"'", con);
            cmd.ExecuteNonQuery();
