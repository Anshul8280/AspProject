<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookTicket.aspx.cs" Inherits="Online_Bus_Reservation_System.BookTicket" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <table class="auto-style4">
                <tr>
                    <td colspan="2">Book Ticket</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style6">Bus Number :-</td>
                    <td>
